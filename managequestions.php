<?php
 ...
 if(!isset($_SESSION['username']))
    header('locationhttps:http://localhost/public_html/adminlogin.php');
 if($_SESSION['username']!='ashish')
    header('locationhttps:http://localhost/public_html/index.html');
?>
<html>
<head>
      ...
      <div class="row">
        <div id="header" class="page-header">
          ...
          <nav id="subnav" class="">
		      ...
		      <li role="presentation" class="active"><a href="http://localhost/public_html/managequestions.php">Manage Questions</a>
		          <li role="presentation" class=""><a href="http://localhost/public_html/createquestion.php">Create Questions</a></li>
       ...
       <a  class="thumbnail" href="http://localhost/public_html/createquestion.php"><img class="img img-responsive" id="createquestionimage" src="images/questionsimage.jpg" width="" height="" /><h5 id="content">Create Question</h5>  </a>
       </div>
       <div class="co-xs-6 col-md-3">
             <a href="http://localhost/public_html/viewquestion.php"><img class="img img-responsive" id="viewimage" src="images/viewimage.png" width="" height="" />
           <h5 id="content">View Questions</h5>  </a>
          </div>
