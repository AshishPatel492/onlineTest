...
<header class="container">
      ...
      <ul class="nav nav-tabs nav-justified navbar-right">
        ...
        <li class="nav active" role="presentation"><a href="http://localhost/public_html/adminlogin.php">Admin Login</a></li>
 ...
 <div class="container" id="page-header">
  ...
  <section>
   ...
   <div class="page-header">
	...
	<form action="http://localhost/public_html/adminvalidation.php" method="post">

		  <div class="form-group">

		    <label for="forusername">Admin User</label>

		    <input id="forusername" class="form-control" type="text" name="username" placeholder="Username" />
